...
export const RefundAndExchange = (
    <div className="flex flex-col gap-2 ">
        ...
        <div className="py-1">
            ...
            <div>
                <div>
                    ...
                    <div>
                        <div className="pt-2 pb-2  font-bold">단순 변심에 해당하는 사유</div>
                    ...
                    <div className="pt-2 pb-2  font-bold">기타</div>
                    <div className="ps-2 ">• 현지 판매처에 의한 배송지연(기상악화, 배송 급증, 현지 공휴일 등)</div>
                </div>
            </div>
        </div>
        <div className="py-1 ">
        ...
        <div className="py-1 ">
            ...
            <div className=" pb-1">
                물품 수령 후 7일 이전의 경우 반품 및 취소 신청 가능합니다. 아래의 양식으로 고객센터 메일(
