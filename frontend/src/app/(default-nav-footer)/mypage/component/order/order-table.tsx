...
const item = "flex justify-evenly text-center py-3 my-auto link-animation text-sm";
                ...
                <div className={`border-main-black justify-evenly relative`}>
                    ...
                    {orderList.map((order, idx) => (
                        <div
                            ...
                            <div className="m-auto basis-1/4 underline text-xs">{order.userOrderNumber}</div>
                            ...
                            <div className="m-auto basis-1/4">{"₩" + order.orderTotalPrice.toLocaleString()}</div>
                        </div>
                    ))}
                </div>
