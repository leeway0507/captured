...
import PersonalInfo from "@/app/(custom-nav-footer)/policy/privacy/agreement-personal-info/agreement-personal-info";
import ServicePolicy from "@/app/(custom-nav-footer)/policy/service/service-policy";
import ThirdPartyPolicy from "@/app/(custom-nav-footer)/policy/privacy/agreement-third-party/third-party-policy";
