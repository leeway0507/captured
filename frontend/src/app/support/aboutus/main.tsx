...
export default function Main() {
    return (
        <div className="max-w-4xl w-full m-auto py-32 ">
            <div className="flex-center flex-col">
                <div className="text-2xl tb:text-4xl pb-4">전세계 숨은 재고를 찾아 검거하는</div>
                <div
            ...
            <div className="text-base tb:py-16">
                <div className="flex flex-wrap tb:flex-nowrap pt-16 pb-8 px-4 gap-8">
                    ...
                    <div className="tb:basis-3/5 w-full ">
                        <div className="py-8 w-full relative h-[200px] tb:h-[300px]">
                            <Image src="/icons/captured_map.png" alt="captured_map" fill className="rounded-lg" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-wrap flex-col-reverse tb:flex-row tb:flex-nowrap py-8 tb:py-16 px-4 gap-8">
                    <div className="tb:basis-3/5 w-full ">
                        <div className="py-8 w-full relative h-[200px] tb:h-[300px]">
                            <Image src="/icons/captured_logo.png" alt="captured_logo" fill className="rounded-lg" />
                        </div>
                    </div>
                    <div className="tb:basis-2/5 pt-4">
                        <div className="text-2xl pb-2">믿음의 철칙</div>
