        ...
        <div>
            <>
                ...
                <div className="flex flex-col gap-2">
                    <div>회사의 서비스 이행을 위하여 다음의 경우 개인정보를 제3자에게 제공하고 있습니다.</div>
                    <ul className="list-inside flex flex-col gap-1">
                        ...
                        <li>
                            <span className="px-2">•</span>법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와
            ...
            <>
                ...
                <div className="flex flex-col gap-2">
                    <div>
                        회사의 서비스 이행을 위하여 개인정보를 국외 제3자에게 제공하고 있는 경우는 다음과 같습니다.
                    </div>
                    <ul className="list-inside flex flex-col gap-1">
                        <li>
                            <span className="px-2">•</span>수입 및 통관 업무의 경우
            ...
            <>
                ...
                <div className="flex flex-col gap-2">
                    <div>회사는 서비스의 원활한 제공을 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</div>
