...
// The OrderRowFunc type is an adapter to allow the use of ordinary
// function as OrderRow mutator.
type OrderRowFunc func(context.Context, *ent.OrderRowMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrderRowFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OrderRowMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OrderRowMutation", m)
}
...
// The SizeFunc type is an adapter to allow the use of ordinary
// function as Size mutator.
type SizeFunc func(context.Context, *ent.SizeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SizeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SizeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SizeMutation", m)
}
